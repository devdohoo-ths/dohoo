...
-- ============================================
-- O problema: profiles.role_id tem foreign key apenas para roles,
-- mas agora temos roles também em default_roles
-- Solução: Remover a constraint atual e criar função de validação
-- ============================================
